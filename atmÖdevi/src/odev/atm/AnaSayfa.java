			   ...
			   if(kurumsalMusteri.getMusteriNo().equals(musteriNo)){
			      ...
			      if(islemNo==1) {
			    	  ...
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIslemleriManager.paraYatýrma(kurumsalMusteri,paraMiktarý);
			      }
			      else if(islemNo==2) {
			    	  System.out.println("Çekmek istediðiniz para miktarýný giriniz:");
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIslemleriManager.paraÇekme(kurumsalMusteri,paraMiktarý);
			      }
			      ...
			      if(islemNo==1) {
			    	  System.out.println("Yatýrmak istediðiniz para miktarýný giriniz:");
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIslemleriManager.paraYatýrma(bireyselMusteri,paraMiktarý);
			      }
			      else if(islemNo==2) {
			    	  System.out.println("Çekmek istediðiniz para miktarýný giriniz:");
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIslemleriManager.paraÇekme(bireyselMusteri,paraMiktarý);
			      }
			   }

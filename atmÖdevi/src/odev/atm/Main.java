...
public class Main {
	...
	public static void main(String[] args) {
		  ...
		  HesapÝþlemleriManager hesapIþlemleriManager=new HesapÝþlemleriManager(  );
		   ...
		   {  if(musteriBanka.getKey().equals(musteriNo)) {
			   ...
			   if(kurumsalMusteri.getMusteriNo().equals(musteriNo)){
				   System.out.println("TC Kimlik No:"+kurumsalMusteri.getTcNo()+" "+" Ad Soyad:"+kurumsalMusteri.getAdSoyad()+" "+
						   kurumsalMusteri.getSirketÝsmi()+" "+"Hesap Bakiyesi"+kurumsalMusteri.getHesapBakiyesi());
			      ...
			      if(islemNo==1) {
			    	  ...
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIþlemleriManager.paraYatýrma(kurumsalMusteri,paraMiktarý);
			      }
			      else if(islemNo==2) {
			    	  System.out.println("Çekmek istediðiniz para miktarýný giriniz:");
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIþlemleriManager.paraÇekme(kurumsalMusteri,paraMiktarý);
			      }
			      ...
			      if(islemNo==1) {
			    	  System.out.println("Yatýrmak istediðiniz para miktarýný giriniz:");
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIþlemleriManager.paraYatýrma(bireyselMusteri,paraMiktarý);
			      }
			      else if(islemNo==2) {
			    	  System.out.println("Çekmek istediðiniz para miktarýný giriniz:");
			    	  double paraMiktarý = input.nextDouble(); 
			    	   hesapIþlemleriManager.paraÇekme(bireyselMusteri,paraMiktarý);
			      }
			   }
